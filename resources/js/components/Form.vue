<template>
    <div>
        <div class="row justify-content-center">
            <div
                class="col-12 col-md-6 col-lg-4 align-self-center bg-white pt-3 rounded-top"
            >
                <h1 class="fs-3 text-capitalize text-center mb-3">
                    {{ entity.label }}
                </h1>
            </div>
        </div>
        <div class="row justify-content-center">
            <form
                class="col-12 col-md-6 col-lg-4 align-self-center bg-white pb-3 rounded-bottom"
                autocomplete="off"
            ...
            >
                ...
                <div
                    ...
                    :class="{
                        'mb-3':
                            i < entity.fillables.length &&
                            fillable.type !== 'hidden',
                    }"
                    :style="{ 'display: none': fillable.type === 'hidden' }"
                >
                    <label
                        class="form-label w-100 text-capitalize"
                        :for="fillable.codename"
                        v-if="fillable.type !== 'hidden'"
                    >
                        {{ fillable.title }}
                    </label>
                    <Autocomplete
                        ...
                        :loading="loading"
                        :disabled="
                            fillable.hasOwnProperty('dependsOn') &&
                            entity[fillable.dependsOn] === null
                        "
                    />
                    <input
                        type="hidden"
                    ...
                    <div class="input-group has-validation" v-else>
                        <input
                            ...
                            :required="{
                                true: fillable.hasOwnProperty('required'),
                            }"
                            :class="{
